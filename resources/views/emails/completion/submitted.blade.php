        ...
        <table width="560" bgcolor="#ffffff" cellpadding="0" cellspacing="0" style="border-radius:8px;overflow:hidden;box-shadow:0 2px 16px rgba(0,0,0,.07);">
            ...
            <tr><td style="padding:36px 40px;">
                ...
                <p style="color:#555;line-height:1.7;margin:0 0 24px;font-size:15px">
                    Your freelancer, <strong>{{ $freelancer->name }}</strong>, has submitted their completed work along with supporting evidence and documentation. It's now ready for your review.
                </p>
                ...
                <div style="background:#f8f9fa;border-left:4px solid #8B5CF6;padding:16px;margin:24px 0;border-radius:4px;">
                    ...
                    <p style="margin:0 0 8px;color:#555;font-size:13px"><strong>Project:</strong> {{ $contract->job->title }}</p>
                    <p style="margin:0 0 8px;color:#555;font-size:13px"><strong>Contract #:</strong> {{ $contract->contract_number }}</p>
                    <p style="margin:0 0 8px;color:#555;font-size:13px"><strong>Freelancer:</strong> {{ $freelancer->name }}</p>
                    <p style="margin:0 0 0;color:#555;font-size:13px"><strong>Contract Amount:</strong> <span style="color:#8B5CF6;font-weight:bold;">Nu. {{ number_format($contract->total_amount, 2) }}</span></p>
                </div>
                ...
                <div style="background:#DDD6FE;border-left:4px solid #8B5CF6;padding:16px;margin:24px 0;border-radius:4px;">
                    ...
                    <p style="margin:0 0 4px;color:#5B21B6;font-size:13px"><strong>Files Attached:</strong> {{ $submission->attachments()->count() }} file(s)</p>
                    <p style="margin:0;color:#5B21B6;font-size:13px"><strong>Submitted:</strong> {{ $submission->submitted_at->format('M d, Y H:i A') }}</p>
                </div>
                ...
                <div style="background:#F9FAFB;padding:16px;margin:24px 0;border-radius:4px;border:1px solid #E5E7EB;">
                    ...
                    <p style="margin:0;color:#555;font-size:13px;line-height:1.6;">
                        {{ Str::limit($submission->submission_notes, 250) }}
                    </p>
                </div>
                ...
                <div style="text-align:center;margin:28px 0;">
                    <a href="{{ $adminUrl }}" style="background:#8B5CF6;color:#ffffff;text-decoration:none;padding:14px 32px;border-radius:6px;font-weight:bold;font-size:15px;display:inline-block">
                        Review Submission
                    </a>
                </div>

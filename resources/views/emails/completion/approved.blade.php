        ...
        <table width="560" bgcolor="#ffffff" cellpadding="0" cellspacing="0" style="border-radius:8px;overflow:hidden;box-shadow:0 2px 16px rgba(0,0,0,.07);">
            ...
            <tr><td style="padding:36px 40px;">
                ...
                <div style="background:#f8f9fa;border-left:4px solid #10B981;padding:16px;margin:24px 0;border-radius:4px;">
                    ...
                    <p style="margin:0 0 0;color:#555;font-size:13px"><strong>Completion Date:</strong> {{ $submission->verified_at->format('M d, Y') }}</p>
                </div>
                ...
                <div style="background:#ECFDF5;border-left:4px solid #10B981;padding:16px;margin:24px 0;border-radius:4px;">
                    ...
                    <table width="100%" style="border-collapse:collapse;font-size:13px;color:#065F46;">
                        <tr style="border-bottom:1px solid #D1FAE5;">
                            ...
                            <td style="text-align:right;padding:8px 0;">Nu. {{ number_format($contract->total_amount, 2) }}</td>
                        </tr>
                        <tr style="border-bottom:1px solid #D1FAE5;">
                            <td style="padding:8px 0;"><strong>Platform Fee (10%):</strong></td>
                            <td style="text-align:right;padding:8px 0;">-Nu. {{ number_format($contract->platform_fee, 2) }}</td>
                        </tr>
                        <tr>
                            <td style="padding:8px 0;font-weight:bold;font-size:14px;"><strong>Your Earnings:</strong></td>
                            <td style="text-align:right;padding:8px 0;font-weight:bold;font-size:14px;color:#059669;"><strong>{{ $paymentAmount }}</strong></td>
                        </tr>
                    </table>
                </div>
                ...
                <div style="text-align:center;margin:28px 0;">
                    <a href="{{ $walletUrl }}" style="background:#10B981;color:#ffffff;text-decoration:none;padding:14px 32px;border-radius:6px;font-weight:bold;font-size:15px;display:inline-block;">
                        View Your Wallet
                    </a>
                </div>

        ...
        <table width="560" bgcolor="#ffffff" cellpadding="0" cellspacing="0" style="border-radius:8px;overflow:hidden;box-shadow:0 2px 16px rgba(0,0,0,.07);">
            ...
            <tr><td style="padding:36px 40px;">
                ...
                <div style="background:#f8f9fa;border-left:4px solid #10B981;padding:16px;margin:24px 0;border-radius:4px;">
                    ...
                    <p style="margin:0 0 8px;color:#555;font-size:13px"><strong>Your Bid:</strong> <span style="color:#10B981;font-weight:bold;">{{ $bidAmount }}</span></p>
                ...
                <div style="text-align:center;margin:28px 0;">
                    <a href="{{ $contractUrl }}" style="background:#10B981;color:#ffffff;text-decoration:none;padding:14px 32px;border-radius:6px;font-weight:bold;font-size:15px;display:inline-block">
                        View Your Contract
                    </a>
                </div>

    ...
    <tr><td align="center" style="padding:40px 20px;">
        <table width="560" bgcolor="#ffffff" cellpadding="0" cellspacing="0" style="border-radius:8px;overflow:hidden;box-shadow:0 2px 16px rgba(0,0,0,.07);">
            ...
            <tr><td style="padding:36px 40px;">
                <p style="margin:0 0 16px;color:#555;font-size:14px">Hi <strong><?php echo e($user->name); ?></strong>,</p>
                ...
                <p style="color:#555;line-height:1.7;margin:0 0 24px;font-size:15px">
                    Excellent news! Your <strong><?php echo e($documentType); ?></strong> document has been successfully verified by our admin team. Your account credibility has been enhanced, and you can now access all platform features without restrictions.
                </p>
                ...
                <div style="background:#ECFDF5;border-left:4px solid #10B981;padding:16px;margin:24px 0;border-radius:4px;">
                    ...
                    <table width="100%" style="border-collapse:collapse;font-size:13px;color:#065F46;">
                        <tr style="border-bottom:1px solid #D1FAE5;">
                            ...
                            <td style="text-align:right;padding:8px 0;"><?php echo e($documentType); ?></td>
                        </tr>
                        <tr style="border-bottom:1px solid #D1FAE5;">
                        ...
                        <tr>
                            ...
                            <td style="text-align:right;padding:8px 0;"><?php echo e(now()->format('M d, Y H:i A')); ?></td>
                        </tr>
                    </table>
                </div>
                ...
                <div style="text-align:center;margin:28px 0;">
                    <a href="<?php echo e($dashboardUrl); ?>" style="background:#10B981;color:#ffffff;text-decoration:none;padding:14px 32px;border-radius:6px;font-weight:bold;font-size:15px;display:inline-block">
                        Go to Dashboard
                    </a>
                </div>
...
<?php /**PATH C:\Users\tandi\OneDrive\Desktop\Druk-Freelancing-System\resources\views/emails/verification/approved.blade.php ENDPATH**/ ?>
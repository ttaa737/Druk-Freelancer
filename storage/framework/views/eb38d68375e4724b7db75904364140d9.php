        ...
        <div class="card h-100">
            <div class="card-body">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-6 col-sm-3">
                        <a href="<?php echo e(route('reports.freelancer')); ?>" class="btn btn-outline-secondary w-100 py-2 d-flex flex-column align-items-center gap-1 text-decoration-none">

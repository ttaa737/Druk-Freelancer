...
<?php $__env->startSection('title', 'Verify Completion'); ?>

<?php $__env->startSection('content'); ?>
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="fw-bold mb-1">Completion Review</h4>
        <div class="text-muted small">Contract <?php echo e($submission->contract->contract_number); ?></div>
    </div>
...
<div class="row g-4">
    <div class="col-xl-8">
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="fw-semibold mt-1"><?php echo e($submission->submitted_at?->format('d M Y, h:i A')); ?></div>
                    </div>
                    <div class="col-md-6">
                        <div class="text-muted small">Freelancer</div>
                        <a href="<?php echo e(route('admin.users.show', $submission->freelancer)); ?>" class="fw-semibold text-decoration-none mt-1 d-inline-block">
                    ...
                    <div class="col-md-6">
                        ...
                        <a href="<?php echo e(route('admin.users.show', $submission->contract->poster)); ?>" class="fw-semibold text-decoration-none mt-1 d-inline-block">
                            <?php echo e($submission->contract->poster->name); ?>
                        ...
                        <div class="d-flex gap-3 align-items-center border rounded p-3">
                            <div style="width:96px; flex:0 0 96px;">
                                <?php if(str_starts_with($attachment->file_type, 'image')): ?>
                                    <img src="<?php echo e($attachment->file_url); ?>?inline=1" alt="<?php echo e($attachment->file_name); ?>" class="img-fluid rounded" style="max-height:92px; object-fit:cover; width:96px;" />
                                <?php elseif(str_starts_with($attachment->file_type, 'video')): ?>
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="text-muted small">
                                    <?php echo e($attachment->getDocumentTypeLabel()); ?> • <?php echo e(number_format($attachment->file_size / 1024, 1)); ?> KB
                                </div>
                                <?php if($attachment->description): ?>
                                    <div class="text-muted small mt-1"><?php echo e($attachment->description); ?></div>
                                <?php endif; ?>
                            </div>

                            <div class="text-end">
                                <button class="btn btn-sm btn-outline-secondary mb-2" onclick="showPreview('<?php echo e($attachment->file_url); ?>?inline=1', '<?php echo e($attachment->file_type); ?>', '<?php echo e(addslashes($attachment->file_name)); ?>')">
                                    <i class="fa fa-eye me-1"></i>Preview
                                </button>
                                <a href="<?php echo e(route('completion.download-attachment', $attachment)); ?>" class="btn btn-sm btn-outline-primary d-block">
        ...
        <div class="alert alert-danger">
            ...
            <div class="small mt-2">Rejected at <?php echo e($submission->rejected_at?->format('d M Y, h:i A')); ?></div>
        </div>
        <?php endif; ?>

        <?php if($submission->isPaymentProcessed()): ?>
        <div class="alert alert-success">
            <div class="fw-semibold mb-1">Payment Processed</div>
            <div class="small">Verified at <?php echo e($submission->verified_at?->format('d M Y, h:i A')); ?></div>
            <div class="small">Processed at <?php echo e($submission->payment_processed_at?->format('d M Y, h:i A')); ?></div>
        </div>
        <?php endif; ?>
    </div>
        ...
        <div class="card border-0 shadow-sm mb-4">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between mb-2">
                    ...
                    <strong><?php echo e(config('platform.currency')); ?> <?php echo e(number_format($submission->contract->total_amount, 2)); ?></strong>
                </div>
                <div class="d-flex justify-content-between mb-2">
                    <span class="text-muted">Freelancer Receives</span>
                    <strong class="text-success"><?php echo e(config('platform.currency')); ?> <?php echo e(number_format($submission->contract->freelancer_amount, 2)); ?></strong>
                </div>
                <div class="d-flex justify-content-between">
                    <span class="text-muted">Platform Fee</span>
                    <strong class="text-primary"><?php echo e(config('platform.currency')); ?> <?php echo e(number_format($submission->contract->platform_fee, 2)); ?></strong>
                </div>
                <hr>
...
document.getElementById('approveForm')?.addEventListener('submit', async function (e) {
    ...
    try {
        ...
        await submitAction('<?php echo e(route("admin.completions.verify", $submission)); ?>', new FormData(this));
    } catch (error) {
        alert(error.message);
        if (submitBtn) {
...
document.getElementById('rejectForm')?.addEventListener('submit', async function (e) {
    ...
    try {
        ...
        await submitAction('<?php echo e(route("admin.completions.reject", $submission)); ?>', new FormData(this));
    } catch (error) {
        alert(error.message);
        if (submitBtn) {
            submitBtn.disabled = false;
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\tandi\OneDrive\Desktop\Druk-Freelancing-System\resources\views/admin/completions/show.blade.php ENDPATH**/ ?>
...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Druk Freelancer'); ?></title>
    ...
    <div class="row justify-content-center align-items-center min-vh-100">
        <div class="col-md-5 col-lg-4">
            <div class="text-center mb-4">
                <a href="<?php echo e(url('/')); ?>" class="auth-logo text-white text-decoration-none display-6 fw-bold">
...
<?php /**PATH C:\Users\tandi\OneDrive\Desktop\Druk-Freelancing-System\resources\views/layouts/guest.blade.php ENDPATH**/ ?>
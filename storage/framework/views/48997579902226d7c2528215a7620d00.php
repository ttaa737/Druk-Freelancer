...
<head>
    ...
    <title>Admin – <?php echo $__env->yieldContent('title', 'Druk Freelancer'); ?></title>
...
<div class="sidebar" id="adminSidebar">
    ...
    <nav class="mt-2">
        ...
        <a href="<?php echo e(route('admin.jobs.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.jobs.*') ? 'active' : ''); ?>">
        ...
        <a href="<?php echo e(route('admin.disputes.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.disputes.*') ? 'active' : ''); ?>">
...
<div class="main-content">
    <div class="topbar">
        <div class="d-flex align-items-center gap-2">
            ...
            <h5 class="mb-0 fw-semibold"><?php echo $__env->yieldContent('title', 'Dashboard'); ?></h5>
        </div>
        <div class="d-flex align-items-center gap-3">
            <span class="text-muted small d-none d-md-inline"><?php echo e(auth()->user()->name); ?></span>
            <img src="<?php echo e(auth()->user()->avatar_url); ?>" class="rounded-circle" width="32" height="32" style="object-fit: cover;" alt="<?php echo e(auth()->user()->name); ?>">
        </div>
    </div>

    <?php if(session('success')): ?>
        <div class="alert alert-success alert-dismissible fade show"><i class="fa fa-check me-2"></i><?php echo e(session('success')); ?><button type="button" class="btn-close" data-bs-dismiss="alert"></button></div>
    <?php endif; ?>
    <?php if(session('error')): ?>
        <div class="alert alert-danger alert-dismissible fade show"><i class="fa fa-times me-2"></i><?php echo e(session('error')); ?><button type="button" class="btn-close" data-bs-dismiss="alert"></button></div>
    <?php endif; ?>
    <?php if($errors->any()): ?>
...
<?php /**PATH C:\Users\tandi\OneDrive\Desktop\Druk-Freelancing-System\resources\views\layouts\admin.blade.php ENDPATH**/ ?>
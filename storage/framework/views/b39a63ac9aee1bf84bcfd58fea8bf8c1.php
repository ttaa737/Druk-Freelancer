...
<div class="row g-3">
    <div class="col-lg-8">
        ...
        <?php if($proposal->cv_file_path): ?>
        <div class="card mb-3 shadow-sm">
            <div class="card-header bg-white d-flex align-items-center justify-content-between flex-wrap gap-2">
                <div>
                    <h6 class="mb-0 fw-bold"><i class="fa fa-file-pdf me-2"></i>Freelancer CV</h6>
                    <?php if($proposal->isUsingVerifiedCV()): ?>
                    <small class="text-muted mt-2 d-block">
                        <i class="fa fa-check-circle text-success me-1"></i>
                        From verified account documents
                    </small>
                    <?php endif; ?>
                </div>
                <div class="d-flex gap-2 flex-wrap">
                    <a href="<?php echo e(route('proposals.cv.view', $proposal)); ?>" class="btn btn-sm btn-outline-secondary" target="_blank">
                        <i class="fa fa-eye me-1"></i>View CV
                    </a>
                    <a href="<?php echo e(route('proposals.cv.download', $proposal)); ?>" class="btn btn-sm btn-outline-primary">
            ...
            <div class="card-body">
                <?php
                    $cvInfo = $proposal->getCVInfo();
                ?>
                <p class="mb-2 text-muted small">File: <?php echo e($cvInfo['name'] ?? basename($proposal->cv_file_path)); ?></p>
                <?php if($proposal->isUsingVerifiedCV()): ?>
                    <div class="alert alert-success py-2 px-3 small mb-2">
                        <i class="fa fa-check-circle me-1"></i>
                        <strong>Verified Document:</strong> This CV was verified as part of the freelancer's account verification on <?php echo e($cvInfo['date']); ?>. 
                        The freelancer automatically includes this CV with all their proposals for transparency and trust.
                    </div>
                <?php else: ?>

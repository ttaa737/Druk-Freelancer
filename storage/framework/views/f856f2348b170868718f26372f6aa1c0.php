                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="mt-1">
                                        <span class="badge bg-<?php echo e(auth()->user()->verification_status === 'verified' ? 'success' : 'secondary'); ?>">
                                            ...
                                            <?php echo e(ucfirst(auth()->user()->verification_status ?? 'Unverified')); ?>
                    ...
                    <div class="card-body p-4">
                        ...
                        <?php
                            ...
                            $statusMeta = [
                                ...
                                'rejected' => ['class' => 'danger', 'icon' => 'times-circle', 'title' => 'Verification needs attention', 'text' => 'Some documents were rejected. Please review the feedback and resubmit the required documents.'],
                            ...
                            <div class="d-flex align-items-start gap-3">
                                ...
                                <div class="flex-grow-1">
                                    <div class="d-flex flex-wrap align-items-center gap-2 mb-2">
                                        ...
                                        <span class="badge bg-<?php echo e($statusMeta['class']); ?> text-uppercase"><?php echo e(ucfirst($verificationStatus)); ?></span>
                                    </div>

...
<div class="row g-3">
    <div class="col-lg-8">
        ...
        <?php if($contract->status === 'active' && auth()->user()->id === $contract->freelancer_id): ?>
        <div class="card mb-3 shadow-sm border-success">
            <div class="card-header bg-success-subtle">
                <div class="d-flex justify-content-between align-items-center">
                    <h6 class="mb-0 fw-bold text-success"><i class="fa fa-tasks me-2"></i>Project Completion</h6>
                    <?php if($completionSubmission && $completionSubmission->isPending()): ?>
                    <span class="badge bg-warning text-dark">⏳ Pending Review</span>
                    <?php elseif($completionSubmission && $completionSubmission->isVerified()): ?>
                    <span class="badge bg-info">✓ Verified</span>
                    <?php elseif($completionSubmission && $completionSubmission->isPaymentProcessed()): ?>
                    <span class="badge bg-success">✓ Paid</span>
                    <?php elseif($completionSubmission && $completionSubmission->isRejected()): ?>
            ...
            <div class="card-body">
                ...
                <a href="<?php echo e(route('completion.create', $contract)); ?>" class="btn btn-success btn-lg w-100">
                    <i class="fa fa-arrow-up me-2"></i>Submit Project Completion & Evidence
                </a>
                <?php elseif($completionSubmission->isPending()): ?>
                <div class="alert alert-info small mb-3">
                    <i class="fa fa-clock me-1"></i>
                    <strong>Under Review:</strong> Your submission is being verified. Check back soon!
                </div>
                <a href="<?php echo e(route('completion.show', $completionSubmission)); ?>" class="btn btn-outline-primary w-100 btn-sm">
                    <i class="fa fa-eye me-1"></i>View Submission Details
                </a>
                <?php elseif($completionSubmission->isRejected()): ?>
                <div class="alert alert-danger small mb-3">
                    <strong>Feedback:</strong> <?php echo e($completionSubmission->rejection_reason); ?>

                </div>
                <a href="<?php echo e(route('completion.create', $contract)); ?>" class="btn btn-warning w-100">
                    <i class="fa fa-redo me-1"></i>Resubmit with Corrections
                </a>
                <?php elseif($completionSubmission->isVerified()): ?>
                <div class="alert alert-info small mb-3">
                    <i class="fa fa-spinner fa-spin me-1"></i>
                    <strong>Processing:</strong> Your completion has been verified. Payment is being processed...
                </div>
                <?php elseif($completionSubmission->isPaymentProcessed()): ?>
                <div class="alert alert-success small mb-3">
                    <i class="fa fa-check-double me-1"></i>
                    <strong>Payment Processed!</strong> Nu. <?php echo e(number_format($contract->freelancer_amount, 2)); ?> has been transferred to your wallet.
                </div>
                <a href="<?php echo e(route('wallet.index')); ?>" class="btn btn-outline-success w-100 btn-sm">
        ...
        <?php if($contract->status === 'active' && auth()->user()->id === $contract->poster_id): ?>
        <div class="card mb-3 shadow-sm border-primary">
            ...
            <div class="card-body">
                ...
                <a href="<?php echo e(route('completion.show', $completionSubmission)); ?>" class="btn btn-outline-primary btn-sm w-100">
                    <i class="fa fa-eye me-1"></i>View Submitted Evidence
                </a>
                <?php elseif($completionSubmission->isRejected()): ?>
                <div class="alert alert-danger small mb-3">
                    <strong>Admin Feedback:</strong> <?php echo e($completionSubmission->rejection_reason); ?>

                </div>
                <a href="<?php echo e(route('completion.show', $completionSubmission)); ?>" class="btn btn-outline-danger btn-sm w-100">
                ...
                <a href="<?php echo e(route('completion.show', $completionSubmission)); ?>" class="btn btn-outline-success btn-sm w-100">

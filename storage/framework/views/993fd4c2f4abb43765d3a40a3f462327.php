    ...
    <div class="col-md-8">
        <div class="card h-100">
            <div class="card-body">
                ...
                <?php if($user->profile && !$user->profile->is_verified): ?>
                <div class="alert alert-warning py-2 px-3 mt-3 mb-0 d-flex align-items-center gap-2" style="font-size:.82rem">
                    <i class="fa fa-exclamation-triangle"></i>
                    <div>Your profile is not verified yet. <a href="<?php echo e(route('profile.edit')); ?>" class="alert-link">Complete verification</a> to unlock all features.</div>
                </div>
                <?php endif; ?>
            </div>
        </div>

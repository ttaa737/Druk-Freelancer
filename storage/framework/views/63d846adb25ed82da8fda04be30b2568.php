...
<div class="invoice-meta">
    <div>
        ...
        <div class="value">#<?php echo e($invoice_number); ?></div>
    </div>
    <div>
        <div class="label">Issue Date</div>
        <div class="value"><?php echo e($issue_date); ?></div>
    </div>
    <div>
        <div class="label">Contract ID</div>
        <div class="value">#<?php echo e($contract->id); ?></div>
    </div>
    <div>
        <div class="label">Status</div>
        <div class="value">
            <span class="badge badge-<?php echo e($contract->status === 'completed' ? 'success' : 'warning'); ?>"><?php echo e(ucfirst($contract->status)); ?></span>
        </div>
    </div>
</div>
...
<div class="parties">
    <div class="party">
        ...
        <p>
            <strong><?php echo e($contract->poster?->name); ?></strong><br>
            <?php echo e($contract->poster?->email); ?><br>
            <?php echo e($contract->poster?->profile?->dzongkhag ?? ''); ?>, Bhutan
        </p>
    </div>
    <div class="party">
        <h4>Service Provider (Freelancer)</h4>
        <p>
            <strong><?php echo e($contract->freelancer?->name); ?></strong><br>
            <?php echo e($contract->freelancer?->email); ?><br>
            <?php echo e($contract->freelancer?->profile?->dzongkhag ?? ''); ?>, Bhutan
        </p>
    </div>
</div>
...
<div style="margin: 0 32px 16px; padding: 12px; background: #f0f4f8; border-left: 4px solid #1A3A5C; border-radius: 4px;">
    <div style="font-weight: bold; color: #1A3A5C; font-size: 13px; margin-bottom: 4px;"><?php echo e($contract->title); ?></div>
    <div style="color: #666; font-size: 11px;"><?php echo e(Str::limit($contract->description, 200)); ?></div>
</div>
...
<table class="milestones">
    ...
    <tbody>
        <?php $__currentLoopData = $contract->milestones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $milestone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            <td><?php echo e($i + 1); ?></td>
            <td><?php echo e($milestone->title); ?></td>
            <td><span class="badge badge-<?php echo e($milestone->status === 'approved' ? 'success' : 'secondary'); ?>"><?php echo e(ucfirst($milestone->status)); ?></span></td>
            <td style="text-align:right;font-weight:600"><?php echo e(number_format($milestone->amount)); ?></td>
        </tr>
...
<div class="totals" style="margin-top: 16px;">
    <table>
        <tr>
            <td>Subtotal</td>
            <td style="text-align:right">Nu. <?php echo e(number_format($subtotal)); ?></td>
        </tr>
        <tr>
            <td>Platform Fee (<?php echo e(config('platform.service_fee_percent')); ?>%)</td>
            <td style="text-align:right; color:#e53e3e">– Nu. <?php echo e(number_format($platform_fee)); ?></td>
        </tr>
        <tr class="row-total">
            <td style="padding: 8px 8px; border-radius: 4px 0 0 4px;">Freelancer Receives</td>
            <td style="text-align:right; padding: 8px 8px; border-radius: 0 4px 4px 0;">Nu. <?php echo e(number_format($freelancer_amount)); ?></td>
        </tr>
    </table>
</div>
...
<div style="margin: 16px 32px; padding: 12px; background: #fffbeb; border: 1px solid #F4A823; border-radius: 4px; font-size: 11px; color: #555;">
    <strong>Notes:</strong> <?php echo e($notes); ?>
...
<?php /**PATH C:\Users\tandi\OneDrive\Desktop\Druk-Freelancing-System\resources\views\pdfs\invoice.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('title', 'Submit Completion - ' . $contract->contract_number); ?>
...
<div class="container-fluid px-0">
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-4">
        <div>
            ...
            <div class="text-muted small">Contract <?php echo e($contract->contract_number); ?> • <?php echo e($contract->job->title); ?></div>
        </div>
        <a href="<?php echo e(route('contracts.show', $contract)); ?>" class="btn btn-sm btn-outline-secondary">
            <i class="fa fa-arrow-left me-1"></i>Back to Contract
        </a>
    </div>

    <?php if($existingSubmission && $existingSubmission->isRejected()): ?>
    <div class="alert alert-warning border mb-4">
        ...
        <div class="small"><strong>Admin feedback:</strong> <?php echo e($existingSubmission->rejection_reason); ?></div>
    </div>
    <?php endif; ?>

    <form id="completionForm" method="POST" action="<?php echo e(route('completion.store', $contract)); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
            ...
            <div class="card-body">
                <div class="row g-3 small">
                    <div class="col-md-3">
                        ...
                        <div class="fw-semibold"><?php echo e(config('platform.currency')); ?> <?php echo e(number_format($contract->total_amount, 2)); ?></div>
                    </div>
                    <div class="col-md-3">
                        <div class="text-muted">Platform Fee</div>
                        <div class="fw-semibold"><?php echo e(config('platform.currency')); ?> <?php echo e(number_format($contract->platform_fee, 2)); ?></div>
                    </div>
                    <div class="col-md-3">
                        <div class="text-muted">Freelancer Receives</div>
                        <div class="fw-semibold text-success"><?php echo e(config('platform.currency')); ?> <?php echo e(number_format($contract->freelancer_amount, 2)); ?></div>
                    </div>
                    <div class="col-md-3">
                        <div class="text-muted">Deadline</div>
                        <div class="fw-semibold"><?php echo e($contract->deadline?->format('d M Y') ?? 'N/A'); ?></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="d-flex gap-2">
            <a href="<?php echo e(route('contracts.show', $contract)); ?>" class="btn btn-outline-secondary">Cancel</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\tandi\OneDrive\Desktop\Druk-Freelancing-System\resources\views/completion/create.blade.php ENDPATH**/ ?>
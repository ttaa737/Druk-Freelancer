            ...
            <div class="card">
                ...
                <div style="height:200px; overflow:hidden; display:flex; align-items:center; justify-content:center; background:#f8f9fa;">
                    <?php if($document->file_path): ?>
                        ...
                        <img src="<?php echo e(route('profile.documents.view', $document)); ?>" 
                             class="img-fluid" 
                ...
                <div class="card-footer bg-light border-top p-2">
                    <div class="d-flex gap-2">
                        <a href="<?php echo e(route('profile.documents.view', $document)); ?>" 
                           class="btn btn-sm btn-outline-secondary flex-grow-1" 
                           target="_blank">
                            <i class="fa fa-external-link-alt me-1"></i>Open
                        </a>
                        <a href="<?php echo e(route('profile.documents.download', $document)); ?>" class="btn btn-sm btn-outline-primary flex-grow-1">

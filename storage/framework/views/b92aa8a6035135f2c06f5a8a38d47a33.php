        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <div class="d-flex align-items-center gap-3 p-3 bg-light rounded mb-4">
                    <img src="<?php echo e($reviewee->avatar_url ? Storage::url($reviewee->avatar_url) : asset('img/default-avatar.png')); ?>" class="rounded-circle" style="width:50px;height:50px;object-fit:cover;">
                    <div>
                        <div class="fw-semibold"><?php echo e($reviewee->name); ?></div>
                        <small class="text-muted">Contract: <?php echo e($contract->title); ?></small>
                    </div>
                </div>
                ...
                <form method="POST" action="<?php echo e(route('reviews.store', $contract)); ?>">
                    ...
                    <div class="mb-4">
                        <label class="form-label fw-semibold small"><i class="fa fa-<?php echo e($dim['icon']); ?> me-1 text-warning"></i><?php echo e($dim['label']); ?></label>
